...
void mergeArrays(int *arr1, int size1, int *arr2, int size2, int *arr3){
    ...
    cout << "1: Here Checking value of i: " << i << endl;
    cout << "1: Here Checking value of j: " << j << endl;
    ...
    cout << "2: Here Checking value of i: " << i << endl;
    cout << "2: Here Checking value of j: " << j << endl;
